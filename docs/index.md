...
| `projects/deepseek-v4-support.md` | Initial DeepSeek V4 support PR record: native MP8 engine, official-style TileLang build-time kernels, exact E2E, HTTP chat/completions validation, and nsys-guided validation speed fixes are in place; deeper profiling is deferred. |
