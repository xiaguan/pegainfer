...
| `projects/qwen3-tp-design.md` | Qwen3 tensor-parallel first milestone: `TP=2` for Qwen3-4B, with explicit goals, design constraints, non-goals, and acceptance criteria centered on correctness and future large-model/MoE readiness |
