...
| `projects/deepseek-v4-support.md` | Initial DeepSeek V4 support PR record: native MP8 engine, official-style TileLang build-time kernels, exact E2E, HTTP validation, nsys-guided validation speed fixes, and prefill RoPE cache reuse are in place; deeper profiling is deferred. |
