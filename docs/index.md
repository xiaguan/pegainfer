...
| `projects/deepseek-moe-tilelang-review.md` | Active: official TileKernels MoE maps routing/layout, not a drop-in expert MLP; raw NCCL duration was mostly rank arrival skew; rank-thread decode cut 1x32 steady TPOT to `113.54ms/token`; next step is persistent Qwen3-style rank workers. |
